...
# Parsing Script – EM300 DI - Rev. B

This **Parsing** script is designed for the **EM300 DI** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Parsing – EM300 DI Rev. B

Este script de **Parsing** está diseñado para el modelo **EM300 DI** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
